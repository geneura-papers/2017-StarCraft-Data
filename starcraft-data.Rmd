...
ggplot(aes(x=Race),data=wins.data)+geom_bar(stat=identity)+theme_tufte()+xlab("Winner.Loser")
ggplot(aes(x=Race,y=Ratio),data=wins.data)+geom_bar(stat="identity")+theme_tufte()+xlab("Winner matches per race")
```
