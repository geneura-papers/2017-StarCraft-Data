...
#=====================================================
# Alcanza primero los N minerales
# Required: n variable - number of minerals
#=====================================================

name <- paste0("firstReach",n,"minerals")

t$g_ <- t[,"Winner_TotalMinerals"]
t$l_ <- t[,"Loser_TotalMinerals"]
