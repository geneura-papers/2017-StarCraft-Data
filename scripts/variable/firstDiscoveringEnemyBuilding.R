#=====================================================
# Exploración base enemiga
#=====================================================

name <- paste0("firstDiscoveringEnemyBuilding")

t$g_ <- t[,"Winner_ObservedEnemyBuildingValue"]
t$l_ <- t[,"Loser_ObservedEnemyBuildingValue"]
...
tmp_l <- tmp[tmp$l_ > 0 & tmp$Frame > 0 , c("id","Frame")]
